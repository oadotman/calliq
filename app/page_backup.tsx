...
export default function Dashboard() {
  ...
  const percentageIncrease = Math.round(
    ((metricsData.hoursSavedThisMonth - metricsData.hoursSavedLastMonth) /
      metricsData.hoursSavedLastMonth) *
      100
  );
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
      ...
      <div className="p-4 lg:p-8 space-y-8 animate-in fade-in duration-200">
              ...
              <div className="flex items-start gap-4 pr-8">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-orange-700 mb-3">
                    You've used {metricsData.minutesUsed} of {metricsData.minutesTotal} minutes this
                    month ({Math.round(minutesUsagePercent)}%). Consider upgrading to avoid
                    interruptions.
                  </p>
                  <Link href="/settings">
                ...
                <div className="flex items-start gap-4 pr-8">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-emerald-700">
                      ...
                      {metricsData.hoursSavedThisMonth} hours. Keep up the great work!
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* ROI Banner */}
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-700 to-purple-700 p-6 shadow-2xl shadow-purple-700/30 animate-in fade-in duration-300">
                ...
                <div>
                  ...
                  <div className="flex items-baseline gap-2 mb-1">
                    <h2 className="text-3xl font-bold text-white">
                      {metricsData.hoursSavedThisMonth}
                    </h2>
          ...
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-r from-purple-700/10 via-purple-700/10 to-pink-600/10 rounded-2xl blur-lg opacity-60 group-hover:opacity-80 transition-opacity duration-300" />
            <div className="relative bg-white rounded-2xl p-6 border border-slate-200 shadow-xl hover:shadow-2xl transition-all duration-300 h-full flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  <div className="p-2 bg-gradient-to-br from-purple-700 to-purple-700 rounded-xl">
              ...
              <div className="self-end">
                <div className="relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-purple-700 to-purple-700 rounded-full blur-lg opacity-50" />
                  <div className="relative w-16 h-16 bg-gradient-to-br from-purple-700 to-purple-700 rounded-full flex items-center justify-center shadow-lg">
          ...
          <div className="group relative">
            <Card className="relative border border-purple-100 shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-purple-50 to-pink-50 overflow-hidden group-hover:-translate-y-1">
              ...
              <CardContent>
                ...
                <p className="text-sm text-slate-600 font-medium">Team members online</p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <button className="group relative h-auto p-6 bg-gradient-to-br from-purple-700 to-purple-700 hover:from-purple-800 hover:to-purple-700 text-white rounded-2xl shadow-xl shadow-purple-700/30 hover:shadow-2xl hover:shadow-purple-700/50 transition-all duration-300 hover:-translate-y-1 border-0 overflow-hidden">
          ...
          <Link href="/templates" className="block">
            <button className="group w-full h-full p-6 bg-white hover:bg-slate-50 rounded-2xl border-2 border-slate-200 hover:border-purple-300 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex flex-col items-center text-center gap-3">
                <div className="w-14 h-14 bg-gradient-to-br from-slate-100 to-slate-200 group-hover:from-purple-100 group-hover:to-purple-100 rounded-2xl flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
                  <FileText className="w-7 h-7 text-slate-700 group-hover:text-purple-700" />
                </div>
                <div>
          ...
          <button className="group w-full h-full p-6 bg-white hover:bg-slate-50 rounded-2xl border-2 border-slate-200 hover:border-purple-300 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div className="flex flex-col items-center text-center gap-3">
              <div className="w-14 h-14 bg-gradient-to-br from-slate-100 to-slate-200 group-hover:from-purple-100 group-hover:to-purple-100 rounded-2xl flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
                <Download className="w-7 h-7 text-slate-700 group-hover:text-purple-700" />
              </div>
              <div>
        ...
        <Card className="border-0 shadow-2xl rounded-3xl overflow-hidden bg-white">
          <CardHeader className="bg-gradient-to-r from-slate-50 via-purple-50/30 to-slate-50 border-b border-slate-100">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <Link href="/calls">
                <Button className="bg-gradient-to-r from-purple-700 to-purple-700 hover:from-purple-800 hover:to-purple-700 text-white shadow-lg shadow-purple-700/30 hover:shadow-xl hover:shadow-purple-700/50 transition-all duration-300 rounded-xl border-0 group">
                  View All Calls
            ...
            {recentCalls.length === 0 ? (
              <div className="text-center py-20 px-6">
                <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-gradient-to-br from-purple-100 to-purple-100 flex items-center justify-center">
                  <Phone className="w-12 h-12 text-purple-700" />
                </div>
                ...
                <Button className="bg-gradient-to-r from-purple-700 to-purple-700 hover:from-purple-800 hover:to-purple-700 text-white shadow-xl shadow-purple-700/40 hover:shadow-2xl hover:shadow-purple-700/60 transition-all duration-300 rounded-xl px-8 py-6 text-lg border-0">
                      ...
                      >
                        <td className="px-6 py-5">
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-100 to-purple-100 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-200">
                              ...
                              <Tooltip>
                                ...
                                <TooltipContent className="bg-slate-900 text-white px-3 py-2 rounded-lg">
                                  <p className="font-medium">
                                    Sentiment Score: {call.sentimentScore}/100
                                  </p>
                                </TooltipContent>
                              </Tooltip>
                            </TooltipProvider>
                          ...
                          <div className="flex items-center justify-end gap-2">
                            <Link href={`/calls/${call.id}`}>
                              <Button
                                variant="ghost"
                                size="sm"
                                className="text-purple-700 hover:text-purple-800 hover:bg-purple-100 rounded-lg font-medium transition-all duration-200 group/btn"
                              >
