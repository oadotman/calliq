...
export const metadata: Metadata = {
  ...
  description: "Contact SynQall support team for help with CRM data automation, sales call transcription, or technical assistance. 24-hour response time. Free setup help available.",
  keywords: [
    "contact synqall",
    "customer support",
    "sales inquiry",
  ...
  openGraph: {
    ...
    description: "Need help with SynQall? Our support team responds within 24 hours. Get assistance with setup, integrations, or enterprise solutions.",
