...
export const metadata: Metadata = {
  ...
  description:
    'Transform sales calls into CRM-ready data instantly with AI. Save 15+ minutes per call. Upload audio, get transcripts, extract key insights. No CRM integration required. Try free!',
  keywords: [
    'CRM automation',
  ...
  openGraph: {
    ...
    description:
      'Upload sales calls and get CRM-ready data instantly. Save 15+ minutes per call with AI-powered transcription and data extraction.',
    ...
    <div className="min-h-screen bg-white dark:bg-slate-950">
      ...
      <section className="pt-32 pb-20 px-4 lg:px-8 bg-gradient-to-br from-slate-50 via-white to-purple-50/30 dark:from-slate-950 dark:via-slate-900 dark:to-purple-950/30">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center space-y-8">
            <Badge className="bg-purple-100 dark:bg-purple-950 text-purple-800 dark:text-purple-300 border-purple-200 dark:border-purple-800 px-4 py-1.5 text-sm font-semibold">
            ...
            <p className="text-xl md:text-2xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed">
              Upload your sales call or paste a recording link → SynQall transcribes it → 60 seconds
              extraction → Perfect CRM-ready data.
              <br />
              <span className="font-semibold text-slate-900 dark:text-slate-100">
                Zero IT involvement. Just accurate data.
              </span>
              <br />
              <span className="text-base text-slate-500 dark:text-slate-500 mt-2">
                Works with audio/video files or cloud recording links (Zoom, Google Drive, Dropbox,
                OneDrive)
              </span>
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/signup">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-purple-700 to-purple-700 hover:from-purple-800 hover:to-purple-700 text-white shadow-2xl shadow-purple-700/40 px-8 py-6 text-lg font-semibold rounded-xl hover-glow animate-pulse-glow"
                >
              ...
              <Link href="https://youtu.be/NXpuKIH28Nk" target="_blank" rel="noopener noreferrer">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-slate-300 dark:border-slate-600 text-slate-900 dark:text-slate-100 hover:bg-slate-50 dark:hover:bg-slate-800 px-8 py-6 text-lg font-semibold rounded-xl"
                >
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-10">
            <p className="text-sm font-semibold text-slate-600 dark:text-slate-400 mb-2 uppercase tracking-wider">
              Works With Any CRM—Zero IT Required
            </p>
            <p className="text-sm text-slate-500 dark:text-slate-500 mb-2">
              Works even with custom, internal, or legacy CRMs.
            </p>
            <p className="text-sm text-slate-500 dark:text-slate-500 mb-6">
              No bots. No live call recording. Just paste the link or file after the call.
            </p>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 md:gap-8 items-center justify-items-center">
              ...
              <div className="flex items-center gap-2 group">
                ...
                <span className="text-slate-700 dark:text-slate-300 font-semibold group-hover:text-purple-700 dark:group-hover:text-purple-700 transition-colors">
                  Salesforce
                </span>
              </div>
              {/* HubSpot */}
              ...
              {/* Monday */}
              <div className="flex items-center gap-2 group">
                <div className="w-12 h-12 bg-gradient-to-br from-purple-700 to-purple-700 rounded-lg flex items-center justify-center">
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-400 leading-relaxed">
              Sales reps lose 2+ hours daily on data entry—time that should be spent selling.
              <br />
              <br />
              The result: incomplete data, inconsistent fields across reps, and forecasts nobody
              trusts.
            </p>
          </div>
        </div>
      ...
      <section className="py-20 px-4 lg:px-8 bg-white dark:bg-slate-950">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-slate-900 dark:text-slate-100 mb-6">
              Turn Every Call Into Perfect CRM Data—
              <span className="text-purple-700 dark:text-purple-700">in Under 2 Minutes Total</span>
            </h2>
            <p className="text-xl text-slate-600 dark:text-slate-400 leading-relaxed max-w-3xl mx-auto">
              SynQall automatically transcribes your call and converts it into your exact CRM
              structure.
              <br />
              Your reps just{' '}
              <span className="font-semibold text-slate-900 dark:text-slate-100">
          ...
          <div className="grid md:grid-cols-5 gap-3 mb-12">
            <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-50 dark:from-purple-950 dark:to-purple-950 rounded-2xl border-2 border-purple-200 dark:border-purple-800 hover-lift animate-fade-in-up animate-stagger-1">
              <div className="w-10 h-10 bg-purple-700 rounded-full flex items-center justify-center mx-auto mb-3">
            ...
            <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950 dark:to-cyan-950 rounded-2xl border-2 border-blue-200 dark:border-blue-700 hover-lift animate-fade-in-up animate-stagger-2">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-400">
                SynQall generates a clean, accurate transcript
              </p>
            </div>
            <div className="text-center p-4 bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-950 dark:to-cyan-950 rounded-2xl border-2 border-teal-200 dark:border-teal-700 hover-lift animate-fade-in-up animate-stagger-3">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-400">
                60 seconds to extract all CRM fields
              </p>
              <p className="text-xs text-slate-500 dark:text-slate-500 mt-1">
                Optional: You can also paste your typed notes to help improve the accuracy for
                certain CRM fields.
              </p>
            </div>
            ...
            <div className="text-center p-4 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950 dark:to-orange-950 rounded-2xl border-2 border-amber-200 dark:border-amber-700 hover-lift animate-fade-in-up animate-stagger-5">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-400">
                Copy into your CRM — done
              </p>
            </div>
          </div>
          <Card className="bg-gradient-to-br from-purple-700 to-purple-700 text-white border-0 shadow-2xl">
            <CardContent className="p-8">
              <div className="grid md:grid-cols-3 gap-8 text-center">
                <div>
                  <div className="text-4xl font-bold mb-2">{'< 2 minutes'}</div>
                  <p className="text-purple-100">Total time (60 seconds extraction + 30s review)</p>
                </div>
                <div>
                  <div className="text-4xl font-bold mb-2">High</div>
                  <p className="text-purple-100">Detail accuracy</p>
                </div>
                <div>
                  <div className="text-4xl font-bold mb-2">15+ minutes</div>
                  <p className="text-purple-100">Saved per call</p>
                </div>
              </div>
              <p className="text-center mt-6 text-lg font-medium">
                <span className="font-bold">Total Active Work Time: 90 seconds</span>
                <br />
                <span className="text-purple-100">(because reps only review → not type)</span>
              </p>
              <p className="text-center mt-4 text-lg font-medium">
                Your team instantly recovers 15+ hours weekly, and your CRM becomes a reliable
                source of truth.
              </p>
            </CardContent>
          </Card>
      ...
      <section className="py-20 px-4 lg:px-8 bg-slate-50 dark:bg-slate-900">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-slate-900 dark:text-slate-100 mb-6">
              Less Typing. Better Data.{' '}
              <span className="text-purple-700 dark:text-purple-700">Done Faster.</span>
            </h2>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="border-2 border-purple-200 dark:border-purple-800 shadow-xl">
              <CardHeader className="bg-gradient-to-r from-purple-700 to-purple-700 text-white">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-slate-900 dark:text-slate-100 mb-6">
              ...
              <span className="text-purple-700 dark:text-purple-700">Nothing They Don't.</span>
            </h2>
          </div>
          {/* Multi-Party Call Highlight - USP */}
          <div className="mb-12 p-8 bg-gradient-to-br from-purple-50 to-purple-50 dark:from-purple-950/30 dark:to-purple-950/30 border-2 border-purple-200 dark:border-purple-900 rounded-2xl">
            <div className="flex items-start gap-4">
              <div className="w-14 h-14 bg-gradient-to-br from-purple-700 to-purple-700 rounded-xl flex items-center justify-center flex-shrink-0">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <Badge className="bg-purple-700 text-white border-0">Key Feature</Badge>
                </div>
                <p className="text-lg text-slate-700 dark:text-slate-300 mb-4">
                  Handles complex calls with{' '}
                  <span className="font-semibold text-purple-700 dark:text-purple-700">
                    multiple stakeholders
                  </span>
                  . Add unlimited participants, assign roles, and get clear speaker
                  identification—even on enterprise deals.
                </p>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="font-semibold text-slate-900 dark:text-slate-100">
                        Track Every Participant
                      </p>
                      <p className="text-sm text-slate-600 dark:text-slate-400">
                        Name, role, company for each person
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600 dark:text-slate-400">
                        Perfect for complex buying committees
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2">
            ...
            <Card className="border-2 border-blue-100 dark:border-blue-900 hover:shadow-xl transition-shadow">
              ...
              <CardContent className="space-y-2">
                ...
                <div className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-emerald-600 dark:text-emerald-500 flex-shrink-0 mt-0.5" />
                  <p className="text-sm text-slate-600 dark:text-slate-400">
                    Pain points, challenges, budget
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-emerald-600 dark:text-emerald-500 flex-shrink-0 mt-0.5" />
                  <p className="text-sm text-slate-600 dark:text-slate-400">
                    Timeline, next steps, decision makers
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-emerald-600 dark:text-emerald-500 flex-shrink-0 mt-0.5" />
                  <p className="text-sm text-slate-600 dark:text-slate-400">
                    Objections, competitors, sentiment
                  </p>
                </div>
              </CardContent>
            </Card>

            <Card className="border-2 border-purple-100 dark:border-purple-950 hover:shadow-xl transition-shadow">
              <CardHeader>
              ...
              <CardContent className="space-y-2">
                <div className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-emerald-600 dark:text-emerald-500 flex-shrink-0 mt-0.5" />
                  <p className="text-sm text-slate-600 dark:text-slate-400">
                    Salesforce, HubSpot, Pipedrive templates
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-emerald-600 dark:text-emerald-500 flex-shrink-0 mt-0.5" />
                  <p className="text-sm text-slate-600 dark:text-slate-400">
                    Custom templates for any CRM
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-emerald-600 dark:text-emerald-500 flex-shrink-0 mt-0.5" />
                  <p className="text-sm text-slate-600 dark:text-slate-400">
                    One-time setup, auto-format forever
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-emerald-600 dark:text-emerald-500 flex-shrink-0 mt-0.5" />
                  <p className="text-sm text-slate-600 dark:text-slate-400">
                    Export multiple formats from one call
                  </p>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="py-20 px-4 lg:px-8 bg-gradient-to-br from-purple-50 to-purple-50 dark:from-purple-950 dark:to-purple-950">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-slate-900 dark:text-slate-100 mb-6">
              See Your Team's{' '}
              <span className="text-purple-700 dark:text-purple-700">Time & Cost Savings</span>
            </h2>
            <p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
              Enter your team size and call volume to see how much time and money SynQall saves you
              monthly
            </p>
          </div>
          <ROICalculator />
      ...
      <section className="py-20 px-4 lg:px-8 bg-gradient-to-br from-slate-50 to-purple-50/30 dark:from-slate-900 dark:to-purple-950/30">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-slate-900 dark:text-slate-100 mb-6">
              Works With Any CRM—
              <span className="text-purple-700 dark:text-purple-700">
                Because It Doesn't Rely on Integrations
              </span>
            </h2>
            <p className="text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto">
              Most tools require IT approval, API access, and weeks of setup. SynQall avoids that
              entirely.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="border-2 border-emerald-200 dark:border-emerald-700 bg-emerald-50/50 dark:bg-emerald-950/50 shadow-xl">
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-emerald-600 dark:text-emerald-500 flex-shrink-0 mt-0.5" />
                  <p className="text-slate-700 dark:text-slate-300 font-medium">
                    Works with any CRM, including custom
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-emerald-600 dark:text-emerald-500 flex-shrink-0 mt-0.5" />
                ...
                <div className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-emerald-600 dark:text-emerald-500 flex-shrink-0 mt-0.5" />
                  <p className="text-slate-700 dark:text-slate-300 font-medium">
                    Supports multiple CRMs at once
                  </p>
                </div>
              </CardContent>
            </Card>
      ...
      <section id="security" className="py-20 px-4 lg:px-8 bg-white dark:bg-slate-950">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-slate-900 dark:text-slate-100 mb-6">
              Your CRM Data is{' '}
              <span className="text-emerald-600 dark:text-emerald-400">Sacred to Us</span>
            </h2>
            <p className="text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
            ...
            <Card className="border-2 border-slate-200 dark:border-slate-700 hover:border-emerald-200 dark:hover:border-emerald-700 hover:shadow-xl transition-all">
              <CardContent className="pt-8 pb-6 text-center">
                ...
                <h3 className="font-bold text-lg text-slate-900 dark:text-slate-100 mb-2 text-center">
                  Bank-Level Encryption
                </h3>
            ...
            <Card className="border-2 border-slate-200 dark:border-slate-700 hover:border-emerald-200 dark:hover:border-emerald-700 hover:shadow-xl transition-all">
              <CardContent className="pt-8 pb-6 text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-purple-700 to-purple-700 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
          ...
          <div className="mt-8 text-center">
            <div className="bg-purple-100 dark:bg-purple-950/30 border-2 border-purple-300 dark:border-purple-800 rounded-xl p-4 mb-6 max-w-2xl mx-auto">
              <p className="text-lg font-bold text-purple-950 dark:text-purple-100">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse bg-white dark:bg-slate-800 rounded-xl shadow-lg overflow-hidden">
              <thead className="bg-slate-100 dark:bg-slate-900">
                <tr>
                  <th className="text-left p-4 font-bold text-slate-900 dark:text-slate-100 border-b-2 border-slate-200 dark:border-slate-700">
                    Features
                  </th>
                  <th className="text-center p-4 font-bold text-slate-900 dark:text-slate-100 border-b-2 border-slate-200 dark:border-slate-700">
                    Gong/Chorus
                  </th>
                  <th className="text-center p-4 font-bold text-slate-900 dark:text-slate-100 border-b-2 border-slate-200 dark:border-slate-700">
                    ChatGPT
                  </th>
                  <th className="text-center p-4 font-bold border-b-2 border-purple-300 dark:border-purple-800 bg-purple-50 dark:bg-purple-950/50">
                    <div className="flex flex-col items-center">
                      <span className="text-purple-950 dark:text-purple-300">SynQall</span>
                      <Badge className="bg-purple-700 text-white text-xs mt-1">Best Value</Badge>
                    </div>
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr className="hover:bg-slate-50 dark:hover:bg-slate-900">
                  <td className="p-4 font-medium text-slate-700 dark:text-slate-300 border-b border-slate-100 dark:border-slate-700">
                    Setup Time
                  </td>
                  ...
                  <td className="text-center p-4 border-b border-slate-100 dark:border-slate-700 bg-purple-50/50 dark:bg-purple-950/30">
                    <span className="text-emerald-600 dark:text-emerald-400 font-semibold">
                      5 minutes
                    </span>
                  </td>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-slate-700 dark:text-slate-300">
                    Companies using custom or multi-CRM setups
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-emerald-600 dark:text-emerald-500 flex-shrink-0 mt-0.5" />
                ...
                <div className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-emerald-600 dark:text-emerald-500 flex-shrink-0 mt-0.5" />
                  <p className="text-slate-700 dark:text-slate-300">
                    Organizations with inconsistent CRM data
                  </p>
                </div>
              </CardContent>
            </Card>
            <Card className="border-2 border-red-100 dark:border-red-900 bg-red-50/50 dark:bg-red-950/50">
              ...
              <CardContent className="space-y-3">
                <div className="flex items-start gap-3">
                  <X className="w-5 h-5 text-red-600 dark:text-red-500 flex-shrink-0 mt-0.5" />
                  <p className="text-slate-700 dark:text-slate-300">
                    Solo reps with &lt;5 calls weekly
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <X className="w-5 h-5 text-red-600 dark:text-red-500 flex-shrink-0 mt-0.5" />
                  <p className="text-slate-700 dark:text-slate-300">
                    Teams already using Gong/Chorus for full enablement
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <X className="w-5 h-5 text-red-600 dark:text-red-500 flex-shrink-0 mt-0.5" />
                  <p className="text-slate-700 dark:text-slate-300">
                    Very low call volume organizations
                  </p>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="py-20 px-4 lg:px-8 bg-gradient-to-br from-purple-700 to-purple-700 text-white">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-4xl md:text-6xl font-bold mb-6">Give Your Reps Their Time Back</h2>
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 text-sm font-medium">
            ...
            <div className="flex items-center gap-2">
              <CheckCircle2 className="w-5 h-5" />3 calls included
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle2 className="w-5 h-5" />
              No card required
