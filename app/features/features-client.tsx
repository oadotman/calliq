        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-slate-900 dark:text-slate-100 mb-6">
              ...
              <span className="text-purple-700 dark:text-purple-700">Automate CRM Data Entry</span>
            </h1>
            <p className="text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto">
              From transcription to CRM-ready output, SynQall handles every step of turning sales
              calls into perfect data.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
              The essential tools that make SynQall the fastest way to get accurate CRM data from
              calls
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="border-2 border-purple-100 dark:border-purple-950 hover:shadow-xl transition-shadow">
              <CardHeader>
                <div className="w-12 h-12 bg-gradient-to-br from-purple-700 to-purple-700 rounded-xl flex items-center justify-center mb-4">
              ...
              <CardContent className="space-y-3">
                <p className="text-slate-600 dark:text-slate-400">
                  Handle complex enterprise calls with multiple stakeholders. Unlimited participants
                  with clear speaker identification.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <Check className="w-5 h-5 text-emerald-600 dark:text-emerald-500 flex-shrink-0 mt-0.5" />
                    <span className="text-sm text-slate-600 dark:text-slate-400">
                      Track every participant by name & role
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="w-5 h-5 text-emerald-600 dark:text-emerald-500 flex-shrink-0 mt-0.5" />
            ...
            <Card className="border-2 border-blue-100 dark:border-blue-900 hover:shadow-xl transition-shadow">
              ...
              <CardContent className="space-y-3">
                <p className="text-slate-600 dark:text-slate-400">
                  Industry-leading accuracy with AssemblyAI. Get clean, formatted transcripts in
                  seconds.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
            ...
            <Card className="border-2 border-purple-100 dark:border-purple-900 hover:shadow-xl transition-shadow">
              <CardHeader>
                <div className="w-12 h-12 bg-gradient-to-br from-purple-700 to-pink-600 rounded-xl flex items-center justify-center mb-4">
