    ...
    try {
      ...
      try {
        ...
        if (response.ok) {
          ...
          console.log('✅ Processing endpoint reached, trimmed call will process in background:', callId);
      ...
      if (!processingInitiated) {
        console.error('❌ Could not initiate processing for trimmed call:', lastError);
