      ...
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="space-y-4">
          {faqs.map((faq, idx) => (
            <Card
              key={idx}
              className="border-2 border-slate-200 dark:border-slate-700 cursor-pointer hover:border-purple-300 dark:hover:border-purple-700 transition-colors"
            ...
            >
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  ...
                  {openFaq === idx ? (
                    <ChevronUp className="w-5 h-5 text-purple-700 dark:text-purple-700 flex-shrink-0" />
                  ) : (
