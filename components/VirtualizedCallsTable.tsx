...
const CallRow = memo(
  ({
    ...
    return (
      <div
        style={style}
        className="flex items-center border-b border-slate-100 hover:bg-gradient-to-r hover:from-purple-50/30 hover:to-transparent transition-all duration-200"
      >
            ...
            <div className="flex items-center justify-end gap-2">
              <Link href={`/calls/${call.id}`}>
                <Button
                  size="sm"
                  variant="ghost"
                  className="h-8 w-8 p-0 hover:bg-purple-200 rounded-lg"
                >
