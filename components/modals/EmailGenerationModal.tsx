        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-gray-500">
              Provide specific instructions for what you want to include in the email. The AI will
              use the call transcript and extracted data to personalize it.
            </p>
          </div>
          ...
          {generatedEmail && (
            <div>
              ...
              />
              <p className="mt-2 text-xs text-gray-500">You can edit the email before copying it</p>
            </div>
          )}

          {/* Rate Limit Info */}
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 text-sm text-blue-800">
            <strong>Rate Limit:</strong> You can generate up to 10 follow-up emails per hour to
