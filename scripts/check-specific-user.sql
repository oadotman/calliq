-- =====================================================
-- CHECK SPECIFIC USER WHO REPORTED THE ISSUE
-- Replace 'user@example.com' with the actual user email
-- =====================================================

-- Set the user's email here
\set user_email 'user@example.com'  -- CHANGE THIS TO THE ACTUAL USER EMAIL
...
\echo ''
\echo 'Can this user upload a 3-minute file?'
